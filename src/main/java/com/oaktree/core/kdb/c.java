...
//Object[]x={new Time(lt()),"xx",new Double(93.5),new Integer(300)};for(int i=0;i<1000;++i)c.ks("upsert","trade",x);c.k("");
    ...
    public c(String h, int p, String u) throws KException, IOException {
        ...
        w(u);
        o.write(B);
        if (1 != i.read(B, 0, 1)) throw new KException("access");
    }
    ...
    public static class Date implements Serializable {
        ...
        public java.util.Date Date() {
            return new java.util.Date(i == ni ? nj : 86400000L * (i + 10957));
        }

        public Date(long x) {
            i = x == nj ? ni : (int) (x / 86400000) - 10957;
        }
        ...
        public String toString() {
            return i == ni ? "" : f.format(this.Date());
        }
    ...
    public static class Time implements Serializable {
        ...
        public String toString() {
            return i == ni ? "" : new Second(i / 1000).toString() + '.' + new DecimalFormat("000").format(i % 1000);
        }
    ...
    static int ns(String s) {
        int i;
        return s == null ? 0 : -1 < (i = s.indexOf('\000')) ? i : s.length();
    }
    ...
    static int n(Object x) {
        return x instanceof Dict ? n(((Dict) x).x) : x instanceof Flip ? n(((Flip) x).y[0]) : Array.getLength(x);
    }
    ...
    java.util.Date rz() {
        double f = rf();
        return new java.util.Date(Double.isNaN(f) ? nj : (long) (.5 + 8.64e7 * (f + 10957)));
    }
    ...
    static SimpleDateFormat f = new SimpleDateFormat("yyyy.MM.dd");static {
