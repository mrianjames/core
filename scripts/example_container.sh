...
CLASSPATH="${ROOT}/${PROPERTIES}:${ROOT}/${SCRIPTS}:${ROOT}/${LIB}/com.oaktree.core-2.0.6-SNAPSHOT.jar:${ROOT}/${LIB}/com.oaktree.core-2.0.6-SNAPSHOT-tests.jar:${ROOT}/${LIB}/commons-math-1.2.jar:${ROOT}/${LIB}/slf4j-api-1.7.5.jar:${ROOT}/${LIB}/slf4j-oaktree-1.0.18.jar"
echo "****************************************"
echo ${CLASSPATH}
