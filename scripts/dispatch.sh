#!/bin/bash
JAVA="java"
ROOT="/home/ij/dev/workspace/Core"
LIB="lib"
...
CLASSPATH="${ROOT}/${PROPERTIES}:${ROOT}/${SCRIPTS}:${ROOT}/${LIB}/com.oaktree.core_0.2.jar:${ROOT}/${LIB}/commons-math-1.2.jar:${ROOT}/${LIB}/slf4j-api-1.5.6.jar:${ROOT}/${LIB}/slf4j-oaktree-1.5.6.jar"
echo "****************************************"
